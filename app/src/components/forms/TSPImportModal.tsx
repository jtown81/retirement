...
export function TSPImportModal({ onImport, onCancel }: TSPImportModalProps) {
  ...
  const handleConfirmImport = () => {
    ...
    const newSnapshot: TSPAccountSnapshot = {
      ...
      fundAllocations: [
        { fund: 'G', percentTraditional: 20, percentRoth: 0 },
        { fund: 'F', percentTraditional: 20, percentRoth: 0 },
        { fund: 'C', percentTraditional: 30, percentRoth: 0 },
        { fund: 'S', percentTraditional: 15, percentRoth: 0 },
        { fund: 'I', percentTraditional: 15, percentRoth: 0 },
        { fund: 'L2050', percentTraditional: 0, percentRoth: 0 },
        { fund: 'L2055', percentTraditional: 0, percentRoth: 0 },
        { fund: 'L2060', percentTraditional: 0, percentRoth: 0 },
        { fund: 'L2065', percentTraditional: 0, percentRoth: 0 },
        { fund: 'L2045', percentTraditional: 0, percentRoth: 0 },
        { fund: 'L2040', percentTraditional: 0, percentRoth: 0 },
        { fund: 'L2035', percentTraditional: 0, percentRoth: 0 },
        { fund: 'L2030', percentTraditional: 0, percentRoth: 0 },
        { fund: 'L2025', percentTraditional: 0, percentRoth: 0 },
        { fund: 'L-Income', percentTraditional: 0, percentRoth: 0 },
      ],
